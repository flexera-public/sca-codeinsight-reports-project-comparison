...
set authToken=%3
set reportOptions=%4
rem # This is not currently passed via the framework but should be in a future release
...
python %~dp0\create_report.py -pid %projectId% -rid %reportId% -authToken %authToken% -reportOpts %reportOptions% -baseURL %baseURL%
